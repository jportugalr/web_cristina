...
@section('meta')
    <title>Tienda Rena Ware - {{ $product->name }}</title>    
    <meta name="description" content="{{ Str::limit($product->description, 150) }}">
    <meta name="keywords" content="Rena Ware, {{ $product->name }}, promocion, Cocina Saludable, Filtros de Agua ,Rena Ware Peru, ollas, filtros, ingresos, garantia">
                ...
                <div class="w-full px-[12px]">
                    <div class="flex flex-wrap w-full bb-breadcrumb-inner m-[0] py-[20px] items-center">
                        <div class="min-[768px]:w-[50%] min-[576px]:w-full w-full px-[12px]">
                            ...
                            <h2 class="bb-breadcrumb-title font-quicksand tracking-[0.03rem] leading-[1.2] text-[16px] font-bold text-[#3d4750] max-[767px]:text-center max-[767px]:mb-[10px]">{{ $product->name }}</h2>
                        ...
                        <div class="min-[768px]:w-[50%] min-[576px]:w-full w-full px-[12px]">
                            <ul class="bb-breadcrumb-list mx-[-5px] flex justify-end max-[767px]:justify-center">
                                ...
                                <li class="bb-breadcrumb-item font-Poppins text-[#686e7d] text-[14px] leading-[28px] font-normal tracking-[0.03rem] px-[5px] active "><a href="{{ route('productos.index') }}">Todos los Productos</a></li>
                                <li class="text-[14px] font-normal px-[5px]"><i class="ri-arrow-right-double-fill text-[14px] font-semibold leading-[28px]"></i></li>
                                <li class="bb-breadcrumb-item font-Poppins text-[#686e7d] text-[14px] leading-[28px] font-normal tracking-[0.03rem] px-[5px] active "><a href="{{ route('productos.mostrar',['slug'=>$product->slug]) }}">{{ $product->name }}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="flex flex-wrap mx-[-12px]">
                            ...
                            <div class="min-[992px]:w-[58.33%] w-full px-[12px] mb-[24px]">
                                <div class="bb-single-pro-contact">
                                    ...
                                    <p class="font-Poppins text-[15px] font-light leading-[28px] tracking-[0.03rem]">{{$product->description}}
                                    </p>

                                    <div class="bb-single-pro-weight mt-[24px] mb-[24px]">
                                        <ul class="list-disc pl-[20px] mb-[0]">
                                            <li class="py-[5px] text-[15px] text-[#686e7d] font-Poppins leading-[28px] font-light"><span class="inline-flex font-medium min-w-[150px]">Categoría </span> {{ $product->category->name }}</li>                                            
                                            <li class="py-[5px] text-[15px] text-[#686e7d] font-Poppins leading-[28px] font-light"><span class="inline-flex font-medium min-w-[150px]">Tags</span>
                                    ...
                                    <div class="bb-single-qty flex flex-wrap m-[-2px]">
                                        ...
                                        <div class="buttons m-[2px]">
                                            <a href="{{ route('whatsapp',['id'=>1, 'producto'=>$product->name]) }}" target="_blank">
                        ...
                        <div class="bb-pro-tab mb-[24px]">
                            <ul class="bb-pro-tab-nav flex flex-wrap mx-[-20px] max-[991px]:justify-center" id="ProTab">
                                <li class="nav-item relative leading-[28px]">
                                    <a class=" px-[20px] font-Poppins text-[16px] text-[#686e7d] font-medium capitalize leading-[28px] tracking-[0.03rem] block active" href="#detail">Detalles</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="tab-pro-pane" id="detail">
                                <div class="bb-inner-tabs border-[1px] border-solid border-[#eee] p-[15px] rounded-[20px]">
                                    <div class="bb-details">
                                        <p class="mb-[12px] font-Poppins text-[#686e7d] leading-[28px] tracking-[0.03rem] font-light">{!!$product->detail!!}</p>
                                        <br>
                                        <p class="mb-[12px] font-Poppins text-[#686e7d] leading-[28px] tracking-[0.03rem]">📲 <a href="{{ route('whatsapp', ['id' => 2, 'producto' => $product->nombre]) }}" target="_blank">Comunícate a nuestro WhatsApp para más información.</a></p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="w-full px-[12px]">
                    <div class="section-title mb-[20px] pb-[20px] z-[5] relative flex flex-col items-center text-center max-[991px]:pb-[0]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                        <div class="section-detail max-[991px]:mb-[12px]">
                            <h2 class="bb-title font-quicksand mb-[0] p-[0] text-[25px] font-bold text-[#3d4750] relative inline capitalize leading-[1] tracking-[0.03rem] max-[767px]:text-[23px]">Otros <span class="text-[#6c7fd8]">Productos</span></h2>
                ...
                <div class="w-full px-[12px]">
                    <div class="bb-deal-slider m-[-12px]">
                        <div class="bb-deal-block owl-carousel">
                            ...
                            <x-web.related-product-card :product="$product" />
                        @endforeach
                        </div>
                    </div>
                </div>
