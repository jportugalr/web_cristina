                            ...
                            <div class="min-[992px]:w-[100%] w-full px-[12px] ">
                                <div class="inner-contact mb-[24px]">
                                    <ul class="flex flex-wrap">
                                        <li>
                                            <span aria-hidden="true" href="#pendiente" class="transition-all duration-[0.3s] ease-in-out font-Poppins leading-[28px] tracking-[0.03rem] text-[13px] font-normal text-[#686e7d] hover:text-[#6c7fd8] capitalize"></span>
                                        </li>
                              
                                        @foreach ( $tags as $tag )
                                            <li>                                               
                                                <span aria-hidden="true" href="#pendiente" class="transition-all duration-[0.3s] ease-in-out font-Poppins leading-[28px] tracking-[0.03rem] text-[13px] font-normal text-[#686e7d] hover:text-[#6c7fd8] capitalize">{{ $tag->tag }}</span>
                                            </li>  
                                        @endforeach
                                ...
                                <div class="bb-footer-links bb-footer-dropdown hidden max-[991px]:mb-[35px]">
                                    <ul class="align-items-center">
                                        ...
                                        <li class="bb-footer-link bb-foo-mail  items-center">
                                            ...
                                            <a href="{{ route('contacto') }}" class="transition-all duration-[0.3s] ease-in-out font-Poppins text-[14px] leading-[20px] text-[#686e7d] inline-block relative break-all tracking-[0] font-normal max-[1399px]:text-[15px] max-[1199px]:text-[14px]">maria_roman58@hotmail.com</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="bb-footer-links bb-footer-dropdown hidden max-[991px]:mb-[35px]">
                                    <ul class="align-items-center flex flex-wrap items-center">
                                        <li class="bb-footer-link leading-[1.5] flex items-center pr-[5px]">
                                            <span aria-hidden="true" href="#pendiente" class="transition-all duration-[0.3s] ease-in-out w-[30px] h-[30px] rounded-[5px] bg-[#f35034] hover:bg-[#6c7fd8] capitalize flex items-center justify-center text-[15px] leading-[20px] text-[#686e7d] relative break-all font-normal"><i class="ri-facebook-fill text-[16px] text-[#fff]"></i></span>
                                        </li>
                                        <li class="bb-footer-link leading-[1.5] flex items-center pr-[5px]">
                                            <span aria-hidden="true" href="#pendiente" class="transition-all duration-[0.3s] ease-in-out w-[30px] h-[30px] rounded-[5px] bg-[#f35034] hover:bg-[#6c7fd8] capitalize flex items-center justify-center text-[15px] leading-[20px] text-[#686e7d] relative break-all font-normal"><i class="ri-twitter-fill text-[16px] text-[#fff]"></i></span>
                                        </li>
                                        <li class="bb-footer-link leading-[1.5] flex items-center pr-[5px]">
                                            <span aria-hidden="true" href="#pendiente" class="transition-all duration-[0.3s] ease-in-out w-[30px] h-[30px] rounded-[5px] bg-[#f35034] hover:bg-[#6c7fd8] capitalize flex items-center justify-center text-[15px] leading-[20px] text-[#686e7d] relative break-all font-normal"><i class="ri-linkedin-fill text-[16px] text-[#fff]"></i></span>
                                        </li>
                                        <li class="bb-footer-link leading-[1.5] flex items-center pr-[5px]">
                                            <span aria-hidden="true" href="#pendiente" class="transition-all duration-[0.3s] ease-in-out w-[30px] h-[30px] rounded-[5px] bg-[#f35034] hover:bg-[#6c7fd8] capitalize flex items-center justify-center text-[15px] leading-[20px] text-[#686e7d] relative break-all font-normal"><i class="ri-instagram-line text-[16px] text-[#fff]"></i></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="bb-bottom-info w-full flex flex-row items-center justify-center max-[991px]:flex-col px-[12px]">
                        <div class="footer-copy max-[991px]:mb-[15px]">
                            <div class="footer-bottom-copy max-[991px]:text-center">
                                <div class="bb-copy text-[#686e7d] text-[13px] tracking-[1px] text-center font-normal leading-[2]">Organización <span class="text-[#162c48] text-[13px] tracking-[1px] text-center font-normal" id="copyright_year"></span>
                                    <span aria-hidden="true" href="#pendiente" class="site-name transition-all duration-[0.3s] ease-in-out font-medium text-[#162c48] hover:text-[#3d4750] font-Poppins text-[15px] leading-[28px] tracking-[0.03rem]">Excelencia Peruana</span> derechos reservados.
                                </div>                                
                            </div>
                        </div>
