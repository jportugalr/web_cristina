...
@section('meta')
    ...
    <title>Rena Ware en {{$departamento->nombre}} | Beneficios y Productos</title>
    <meta name="description" content="Descubre los beneficios de Rena Ware en {{$departamento->nombre}}. Encuentra productos de calidad y promociones especiales.">
    <meta name="keywords" content="Rena Ware {{$departamento->nombre}}, ollas saludables {{$departamento->nombre}}, filtros de agua {{$departamento->nombre}}, promociones Rena Ware {{$departamento->nombre}}">
    <link rel="canonical" href="{{ route('location.departamento', ['slug' => $departamento->slug]) }}">
                ...
                <div class="w-full px-[12px]">
                    <div class="flex flex-wrap w-full bb-breadcrumb-inner m-[0] py-[20px] items-center">
                        <div class="min-[768px]:w-[50%] min-[576px]:w-full w-full px-[12px]">
                            ...
                            <h2 class="bb-breadcrumb-title font-quicksand tracking-[0.03rem] leading-[1.2] text-[16px] font-bold text-[#3d4750] max-[767px]:text-center max-[767px]:mb-[10px]">{{ $departamento->nombre }}</h2>                            
                        </div>
                        <div class="min-[768px]:w-[50%] min-[576px]:w-full w-full px-[12px]">
                            <ul class="bb-breadcrumb-list mx-[-5px] flex justify-end max-[767px]:justify-center">
                                ...
                                <li class="bb-breadcrumb-item font-Poppins text-[#686e7d] text-[14px] leading-[28px] font-normal tracking-[0.03rem] px-[5px] active "><a href="javascript:void(0)">{{ $departamento->nombre }}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
