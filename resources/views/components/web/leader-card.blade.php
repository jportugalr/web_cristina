        ...
        <div class="bb-team-socials transition-all duration-[0.3s] ease-in-out bg-[#fff] rounded-tl-[20px] rounded-bl-[20px] absolute right-[-38px]">
            ...
            <ul class="mb-[0] py-[20px] px-[10px]">
                <li class="bb-social-link leading-[28px] pb-[10px]">
                    <a href="#pendiente" aria-hidden="true"><i class="ri-facebook-fill text-[16px] hover:text-[#6c7fd8]"></i></a>
                </li>
                <li class="bb-social-link leading-[28px] pb-[10px]">
                    <a href="#pendiente" aria-hidden="true"><i class="ri-twitter-x-fill text-[16px] hover:text-[#6c7fd8]"></i></a>
                </li>
                <li class="bb-social-link leading-[28px]">
                    <a href="#pendiente" aria-hidden="true"><i class="ri-linkedin-fill text-[16px] hover:text-[#6c7fd8]"></i></a>
                </li>
            </ul>
        </div>
